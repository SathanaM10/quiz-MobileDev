            ...
            if (snapshot.hasData) {
              return ListView.builder(
                  ...
                  itemBuilder: ((context, index) {
                    var petsIndex = snapshot.data!.docs[index];
                    //------------ สไลด์เมนู Slidable ------------
                    return Slidable(
                      ...
                      endActionPane:
                          ...
                          onPressed: (context) {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    ...
                                    settings:
                                        RouteSettings(arguments: petsIndex)));
                          },
                        ...
                        SlidableAction(
                          onPressed: (context) {
                            petsCollection.doc(petsIndex.id).delete();
                          },
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          ...
                          title: Text(
                            "${petsIndex['name']} • ${petsIndex['age']} year(s)",
                            style: TextStyle(
                              fontSize: 20,
                          ...
                          leading: CircleAvatar(
                            ...
                            child:
                                Icon(Icons.pets, color: Colors.teal, size: 30),
                          ),
                          trailing:
...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.grey[100], // เพิ่มพื้นหลังสีอ่อน
      appBar: AppBar(
        title: Container(
          decoration: BoxDecoration(
            color: Colors.white,
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    // ไปยังหน้ารายละเอียดของสัตว์เลี้ยง
                  },
                ),
              );
            },
